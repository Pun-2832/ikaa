...
<body class="animsition">
    ...
    <!-- Title page -->
    <section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/img-bg/bg-01.jpg');">
        ...
        <div class="container">
            ...
            <div class="row p-b-148">
                <div class="col-md-7 col-lg-8">
                    <div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
                        ...
                        <p class="stext-113 cl6 p-b-26">
                            ตำแหน่ง - Project Manager , Developer
                        </p>
                        <hr>
                        <p class="stext-113 cl6 p-b-26">
                ...
                <div class="col-11 col-md-5 col-lg-4 m-lr-auto">
                    <div class="how-bor1 ">
                        <div class="hov-img0">
                            <img src="images/img-about/about.jpg" alt="IMG">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row p-b-148">
                ...
                <div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
                    <div class="how-bor2">
                        <div class="hov-img0">
                            <img src="images/img-about/pun.jpg" alt="IMG">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row p-b-148">
                ...
                <div class="col-11 col-md-5 col-lg-4 m-lr-auto">
                    <div class="how-bor1 ">
                        <div class="hov-img0">
                            <img src="images/img-about/bam.jpg" alt="IMG">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row p-b-148">
                ...
                <div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
                    <div class="how-bor2">
                        <div class="hov-img0">
                            <img src="images/img-about/nim.jpg" alt="IMG">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row p-b-148">
                ...
                <div class="col-11 col-md-5 col-lg-4 m-lr-auto">
                    <div class="how-bor1 ">
                        <div class="hov-img0">
                            <img src="images/img-about/bell.jpg" alt="IMG">
                        </div>
                    </div>
                </div>
            </div>
