...
<head>
    ...
    <!--===============================================================================================-->
    <script src="https://kit.fontawesome.com/fda2e748c5.js" crossorigin="anonymous"></script>
    <!--===============================================================================================-->
    <!--===============================================================================================-->
</head>
...
<body class="animsition">
    ...
    <header class="header-v4">
        ...
        <div class="wrap-header-mobile">
            ...
            <div class="wrap-icon-header flex-w flex-r-m m-r-15">
                ...
                <div class="icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 js-show-cart" data-notify="0">
                    <i class="zmdi zmdi-shopping-cart"></i>
                </div>
    ...
    <div class="wrap-header-cart js-panel-cart">
        ...
        <div class="header-cart flex-col-l p-l-65 p-r-25 js-cd-cart">
    ...
    <?php
    include("connectdb.php"); //รวมโค้ดกัน
    $sql = "SELECT category.c_name, products.p_name
    FROM category
                    ...
                    <div class="p-l-25 p-r-30 p-lr-0-lg">
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="gallery-lb">
                                <div class="item-slick3" data-thumb="/Member/images/img-home/<?= $data['p_img']; ?>">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="Member/images/img-home/<?= $data['p_img']; ?>">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="Member/images/img-home/<?= $data['p_img']; ?>">
                    ...
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <div class="p-t-33">
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                ...
                                <p>
                                    <a id="addToCartLink" href="#" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04" role="button" onclick="alert('กรุณาเข้าสู่ระบบ');">หยิบลงตะกร้า</a>
                                </p>
