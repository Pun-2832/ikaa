                ...
                <div class="sidebar-gallery w-full p-tb-30">
                    ...
                    <div class="flex-w flex-sb p-t-36 gallery-lb">
                        ...
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/img-gallery/gallery-01.jpg"
                                data-lightbox="gallery"
                                style="background-image: url('images/img-gallery/gallery-01.jpg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/img-gallery/gallery-02.jpg"
                                data-lightbox="gallery"
                                style="background-image: url('images/img-gallery/gallery-02.jpg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/img-gallery/gallery-03.jpg"
                                data-lightbox="gallery"
                                style="background-image: url('images/img-gallery/gallery-03.jpg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/img-gallery/gallery-04.jpg"
                                data-lightbox="gallery"
                                style="background-image: url('images/img-gallery/gallery-04.jpg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/img-gallery/gallery-05.jpg"
                                data-lightbox="gallery"
                                style="background-image: url('images/img-gallery/gallery-05.jpg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/img-gallery/gallery-06.jpg"
                                data-lightbox="gallery"
                                style="background-image: url('images/img-gallery/gallery-06.jpg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/img-gallery/gallery-07.jpg"
                                data-lightbox="gallery"
                                style="background-image: url('images/img-gallery/gallery-07.jpg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/img-gallery/gallery-08.jpg"
                                data-lightbox="gallery"
                                style="background-image: url('images/img-gallery/gallery-08.jpg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/img-gallery/gallery-09.jpg"
                                data-lightbox="gallery"
                                style="background-image: url('images/img-gallery/gallery-9.jpg');"></a>
                        </div>
                    </div>
                </div>
							...
							<td>
								<a href="clear3.php?id=<?=$pid;?>">
									<div class="how-itemcart1">
										<img src="images/img-home/<?= $_SESSION['spicture'][$pid]; ?>">
									</div>
								</a>
							</td>
							<td>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-3 p-b-50">
                    ...
                    <p class="stext-107 cl7 size-201">
                        Any questions? Let us know in store at IKAA STORE, Tambon Kham Riang, Amphoe Kantharawichai,
                        Chang Wat Maha Sarakham 44150 or call us on (+66) 999999999
                    </p>
